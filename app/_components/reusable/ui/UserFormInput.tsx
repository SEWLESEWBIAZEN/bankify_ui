...
const UserFormInput = ({value,changeFunc,state,label, Icon,name}:{value:string ,changeFunc:(x:any)=>void,state:UserRegisterState,label:string, Icon:any,name:string}) => {
  return (
    <div>
